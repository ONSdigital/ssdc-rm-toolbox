...
def test_region_matches_treatment_code_valid():
    # Given
    region_matches_treatment_code_validator = validation_rules.region_matches_treatment_code()
...
def test_ce_u_has_expected_capacity_valid():
    # Given
    ce_u_has_expected_capacity_validator = validation_rules.ce_u_has_expected_capacity()
...
def test_ce_e_has_expected_capacity_valid():
    # Given
    ce_e_has_expected_capacity_validator = validation_rules.ce_e_has_expected_capacity()
